...
/** Intended to prevent Invalid Curve Attack
  */
object PointOnCurve {
  ...
  // def isPointOnCurveSecp256k1(x: BigInt, y: BigInt) = {
  //   // y**2 == x**3 + 7
  ...
  def isPointOnCurveP_256(x: BigInt, y: BigInt) = {
    val a: BigInt = -3
  ...
  def isPointOnCurveP_384(x: BigInt, y: BigInt) = {
    val a: BigInt = -3
    val b: BigInt =
  ...
  def isPointOnCurveP_521(x: BigInt, y: BigInt) = {
    val a: BigInt = -3
    val b: BigInt = BigInt(
